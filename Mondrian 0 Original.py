...
def conditions(x,y,w,h,t):
    ...
    """
    splitpoint_w = random.uniform((1/3)*w, (2/3)*w)#determine the point along the width where vertical splitting will occur
    splitpoint_h = random.uniform((1/3)*h,(2/3)*h)#determine the point along the height where horizontal splitting will occur
